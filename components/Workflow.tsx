...
const status = (props:{status:any}) => {
    ...
    return (
        <div className='flex flex-col pb-3 bg-[#202020] text-white/80 rounded-md relative shadow-xl'>
            <div className='flex px-4 pt-3 mr-4 cursor-pointer select-none whitespace-nowrap overflow-hidden max-w-full' onClick={()=>setShow(!show)}>
                <div className='mr-3'>
                    {(() => {
            ...
            <div style={{height:show ? 222: 0,marginTop: show ? 8:0}} className={`overflow-hidden transition-all px-4`}>
